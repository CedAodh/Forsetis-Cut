...
brightonmacha
	...
	.text "It just..."
	.byte NewLine
	.text "saddens me to see what a terrifying place"
	.byte NewLine
	...
	.byte WaitForA
	.byte ScrollText
	.text "And everything that spineless coward"
	.byte NewLine
	.text "Raydrik has done."
	.byte NewLine
	...
	.byte WaitForA
	.byte ScrollText
	.text "Back when the skies were clear,"
	.byte NewLine
	.text "children smiled,"
	.byte NewLine
	...
	.byte NewLine
	.text "but we can always fight for a better future,"
	.byte NewLine
	.text "right?"
	.byte WaitForA
	...
	.byte NewLine
	.text "how tough it must have been for you..."
	.byte WaitForA
	.byte NewLine
	.text "To go against your knighthood,"
	.byte NewLine
	.text "and to oppose your father."
	.byte WaitForA
	.byte ScrollText
	.text "You once told me he served under"
	.byte NewLine
	.text "Raydrik himself, yes?"
	.byte WaitForA
	...
	.text "That's right..."
	.byte NewLine
	.text "It certainly was a decision"
	.byte NewLine
	.text "that weighed heavily on me."
	.byte WaitForA
	.byte ScrollText
	.text "But after seeing the people's suffering"
	.byte NewLine
	.text "like this,"
	.byte NewLine
	.text "I knew I couldn't turn my back on them."
	.byte WaitForA
	.byte ScrollText
	.text "Eventually, I came to realize"
	.byte NewLine
	...
	.byte NewLine
	.text "we will see Munster freed from this inhumanity!"
	.byte WaitForA
	...
	.byte WaitForA
	.byte ScrollText
	.text "Even with the dark times we live in..."
	.byte NewLine
	.text "your eyes shine brightly,"
	.byte WaitForA
	.byte NewLine
	.text "and it's that that gives me hope"
	.byte NewLine
	.text "for the better future you speak of."
	.byte WaitForA
	...
	.text "So please,"
	.byte NewLine
	.text "never hesitate to come find me"
	.byte NewLine
